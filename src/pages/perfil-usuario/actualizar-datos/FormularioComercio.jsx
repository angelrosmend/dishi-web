...
import { condicionIva, dayOptions, monthOptions, yearOptions } from '../../registro/Options'
...
const FormularioComercio = () => {
                                                      ...
                                                      .then(response => {
                                                        console.log('registro',response, response.config, registroConfig)
                                                          if(response.data.isSuccess === true){
                                                            ...
                                                            user.Usuario.Cuit = values.cuit
                                                            user.Usuario.IdCondicionIva = values.condicionIva
                                                            user.Usuario.RazonSocial = values.razonSocial
                                                          }
                                                          else {
    ...
    const validationSchema = Yup.object().shape({
        ...
        condicionIva: Yup.number().typeError('Caracter invalido'),
        cuit: Yup.number().typeError('Ha ingresado un caracter invalido'),
        razonSocial: Yup.string().typeError('Caracter invalido'),
